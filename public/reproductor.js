...
(function ($) {
	...
	$.fn.myCast = function (options) {
        var settings = $.extend({
			...
			enable_cors: false,
			cors: "https://kastproxy-us.herokuapp.com/,https://kastproxy-eu.herokuapp.com/,https://cors-anywhere.herokuapp.com/,https://cors.io/?,https://shoutcastapps.herokuapp.com",
			artwork: true,
            logo: "img/logo.jpg",
